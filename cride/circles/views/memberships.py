...
# Serializers
from cride.circles.serializers import MembershipModelSerializers, AddMemberSerializer
...
class MembershipViewSet(mixins.ListModelMixin,
    ...
    serializer_class = MembershipModelSerializers
    ...
    def invitations(self, request, *args, **kwargs):
        ...
        data = {
            'used_invitations': MembershipModelSerializers(invited_members, many=True).data,
